...
type
  ...
  public
    constructor Create(AMultiplicity: TMultiplicity; AColumnsName, AColumnsNameRef: TArray<string>;
      AClassNameRef: string; AProperty: TRttiProperty); overload;
    constructor Create(AMultiplicity: TMultiplicity; AColumnsName, AColumnsNameRef: TArray<string>;
      AClassNameRef: string; AProperty: TRttiProperty; AColumnsSelectRef: TArray<string>); overload;
...
begin
  Create(AMultiplicity, AColumnsName, AColumnsNameRef, AClassNameRef, AProperty, nil);
end;

constructor TAssociationMapping.Create(AMultiplicity: TMultiplicity; AColumnsName,
  AColumnsNameRef: TArray<string>; AClassNameRef: string; AProperty: TRttiProperty; AColumnsSelectRef: TArray<string>);
var
  iFor: Integer;
begin
...
destructor TIndexeMapping.Destroy;
begin
  inherited;
end;
