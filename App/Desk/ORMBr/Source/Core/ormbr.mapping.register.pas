...
begin
  try
    ...
    for iFor := 0 to FEntitys.Count -1 do
      Result[iFor] := FEntitys[iFor];
  finally
    FEntitys.Clear;
  end;
end;
...
begin
  try
    ...
    for iFor := 0 to FTriggers.Count -1 do
      Result[iFor] := FTriggers[iFor];
  finally
    FTriggers.Clear;
  end;
end;
...
begin
  try
    ...
    for iFor := 0 to FViews.Count -1 do
      Result[iFor] := FViews[iFor];
  finally
    FViews.Clear;
  end;
end;
