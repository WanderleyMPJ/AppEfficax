...
type
  ...
  public
    ...
    function GeneratorSelectID(AClass: TClass; AID: TValue): IDBResultSet; virtual; abstract;
    function GeneratorSelect(ASQL: String; APageSize: Integer): IDBResultSet; virtual; abstract;
    function GeneratorSelectOneToOne(AOwner: TObject; AClass: TClass; AAssociation: TAssociationMapping): IDBResultSet; virtual; abstract;
    function GeneratorSelectOneToMany(AOwner: TObject; AClass: TClass; AAssociation: TAssociationMapping): IDBResultSet; virtual; abstract;
    ...
    procedure GeneratorUpdate(AObject: TObject; AModifiedFields: TList<string>); virtual; abstract;
    procedure GeneratorInsert(AObject: TObject); virtual; abstract;
    procedure GeneratorDelete(AObject: TObject); virtual; abstract;
  end;
  ...
  public
    ...
    function GeneratorSelectID(AClass: TClass; AID: TValue): IDBResultSet; override;
    function GeneratorSelect(ASQL: String; APageSize: Integer): IDBResultSet; override;
    function GeneratorSelectOneToOne(AOwner: TObject; AClass: TClass; AAssociation: TAssociationMapping): IDBResultSet; override;
    function GeneratorSelectOneToMany(AOwner: TObject; AClass: TClass; AAssociation: TAssociationMapping): IDBResultSet; override;
    ...
    procedure GeneratorUpdate(AObject: TObject; AModifiedFields: TList<string>); override;
    procedure GeneratorInsert(AObject: TObject); override;
    procedure GeneratorDelete(AObject: TObject); override;
  end;
...
//  Result := FConnection.ExecuteSQL(FCommandSelecter.GeneratorSelect(ASQL));
...
function TDMLCommandFactory.GeneratorSelectOneToMany(AOwner: TObject;
  AClass: TClass; AAssociation: TAssociationMapping): IDBResultSet;
begin
...
function TDMLCommandFactory.GeneratorSelectOneToOne(AOwner: TObject; AClass: TClass;
  AAssociation: TAssociationMapping): IDBResultSet;
begin
...
function TDMLCommandFactory.GeneratorSelectWhere(AClass: TClass; AWhere: string;
...
function TDMLCommandFactory.GeneratorSelectID(AClass: TClass; AID: TValue): IDBResultSet;
begin
